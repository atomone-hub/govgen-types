...
exports.protobufPackage = "govgen.gov.v1beta1";
...
exports.VotingParams = {
    ...
    encode(message, writer = binary_1.BinaryWriter.create()) {
        if (message.votingPeriodDefault !== undefined) {
            duration_1.Duration.encode(message.votingPeriodDefault, writer.uint32(10).fork()).ldelim();
        }
        if (message.votingPeriodParameterChange !== undefined) {
            duration_1.Duration.encode(message.votingPeriodParameterChange, writer.uint32(18).fork()).ldelim();
        }
        if (message.votingPeriodSoftwareUpgrade !== undefined) {
            duration_1.Duration.encode(message.votingPeriodSoftwareUpgrade, writer.uint32(26).fork()).ldelim();
        }
        if (message.votingPeriodText !== undefined) {
            duration_1.Duration.encode(message.votingPeriodText, writer.uint32(34).fork()).ldelim();
        }
        return writer;
    },
    decode(input, length) {
        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                case 1:
                    message.votingPeriodDefault = duration_1.Duration.decode(reader, reader.uint32());
                    break;
                case 2:
                    message.votingPeriodParameterChange = duration_1.Duration.decode(reader, reader.uint32());
                    break;
                case 3:
                    message.votingPeriodSoftwareUpgrade = duration_1.Duration.decode(reader, reader.uint32());
                    break;
                case 4:
                    message.votingPeriodText = duration_1.Duration.decode(reader, reader.uint32());
                    break;
                default:
                    reader.skipType(tag & 7);
                    break;
    ...
    fromJSON(object) {
        ...
        if ((0, helpers_1.isSet)(object.votingPeriodDefault))
            obj.votingPeriodDefault = duration_1.Duration.fromJSON(object.votingPeriodDefault);
        if ((0, helpers_1.isSet)(object.votingPeriodParameterChange))
            obj.votingPeriodParameterChange = duration_1.Duration.fromJSON(object.votingPeriodParameterChange);
        if ((0, helpers_1.isSet)(object.votingPeriodSoftwareUpgrade))
            obj.votingPeriodSoftwareUpgrade = duration_1.Duration.fromJSON(object.votingPeriodSoftwareUpgrade);
        if ((0, helpers_1.isSet)(object.votingPeriodText))
            obj.votingPeriodText = duration_1.Duration.fromJSON(object.votingPeriodText);
        return obj;
    },
    toJSON(message) {
        const obj = {};
        message.votingPeriodDefault !== undefined &&
            (obj.votingPeriodDefault = message.votingPeriodDefault
                ? duration_1.Duration.toJSON(message.votingPeriodDefault)
                : undefined);
        message.votingPeriodParameterChange !== undefined &&
            (obj.votingPeriodParameterChange = message.votingPeriodParameterChange
                ? duration_1.Duration.toJSON(message.votingPeriodParameterChange)
                : undefined);
        message.votingPeriodSoftwareUpgrade !== undefined &&
            (obj.votingPeriodSoftwareUpgrade = message.votingPeriodSoftwareUpgrade
                ? duration_1.Duration.toJSON(message.votingPeriodSoftwareUpgrade)
                : undefined);
        message.votingPeriodText !== undefined &&
            (obj.votingPeriodText = message.votingPeriodText
                ? duration_1.Duration.toJSON(message.votingPeriodText)
                : undefined);
        return obj;
    },
    fromPartial(object) {
        ...
        if (object.votingPeriodDefault !== undefined && object.votingPeriodDefault !== null) {
            message.votingPeriodDefault = duration_1.Duration.fromPartial(object.votingPeriodDefault);
        }
        if (object.votingPeriodParameterChange !== undefined && object.votingPeriodParameterChange !== null) {
            message.votingPeriodParameterChange = duration_1.Duration.fromPartial(object.votingPeriodParameterChange);
        }
        if (object.votingPeriodSoftwareUpgrade !== undefined && object.votingPeriodSoftwareUpgrade !== null) {
            message.votingPeriodSoftwareUpgrade = duration_1.Duration.fromPartial(object.votingPeriodSoftwareUpgrade);
        }
        if (object.votingPeriodText !== undefined && object.votingPeriodText !== null) {
            message.votingPeriodText = duration_1.Duration.fromPartial(object.votingPeriodText);
        }
        return message;
    },
};

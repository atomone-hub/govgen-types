...
exports.QueryProposalRequest = {
    typeUrl: "/govgen.gov.v1beta1.QueryProposalRequest",
...
exports.QueryProposalResponse = {
    typeUrl: "/govgen.gov.v1beta1.QueryProposalResponse",
    encode(message, writer = binary_1.BinaryWriter.create()) {
...
exports.QueryProposalsRequest = {
    typeUrl: "/govgen.gov.v1beta1.QueryProposalsRequest",
    encode(message, writer = binary_1.BinaryWriter.create()) {
...
exports.QueryProposalsResponse = {
    typeUrl: "/govgen.gov.v1beta1.QueryProposalsResponse",
    encode(message, writer = binary_1.BinaryWriter.create()) {
...
exports.QueryVoteRequest = {
    typeUrl: "/govgen.gov.v1beta1.QueryVoteRequest",
    encode(message, writer = binary_1.BinaryWriter.create()) {
        if (message.proposalId !== BigInt(0)) {
            writer.uint32(8).uint64(message.proposalId);
        }
...
exports.QueryVoteResponse = {
    typeUrl: "/govgen.gov.v1beta1.QueryVoteResponse",
    encode(message, writer = binary_1.BinaryWriter.create()) {
...
exports.QueryVotesRequest = {
    typeUrl: "/govgen.gov.v1beta1.QueryVotesRequest",
    encode(message, writer = binary_1.BinaryWriter.create()) {
        if (message.proposalId !== BigInt(0)) {
            writer.uint32(8).uint64(message.proposalId);
        }
...
exports.QueryVotesResponse = {
    typeUrl: "/govgen.gov.v1beta1.QueryVotesResponse",
    encode(message, writer = binary_1.BinaryWriter.create()) {
...
exports.QueryParamsRequest = {
    typeUrl: "/govgen.gov.v1beta1.QueryParamsRequest",
    encode(message, writer = binary_1.BinaryWriter.create()) {
...
exports.QueryParamsResponse = {
    typeUrl: "/govgen.gov.v1beta1.QueryParamsResponse",
    encode(message, writer = binary_1.BinaryWriter.create()) {
...
exports.QueryDepositRequest = {
    typeUrl: "/govgen.gov.v1beta1.QueryDepositRequest",
    encode(message, writer = binary_1.BinaryWriter.create()) {
        if (message.proposalId !== BigInt(0)) {
            writer.uint32(8).uint64(message.proposalId);
        }
...
exports.QueryDepositResponse = {
    typeUrl: "/govgen.gov.v1beta1.QueryDepositResponse",
    encode(message, writer = binary_1.BinaryWriter.create()) {
...
exports.QueryDepositsRequest = {
    typeUrl: "/govgen.gov.v1beta1.QueryDepositsRequest",
    encode(message, writer = binary_1.BinaryWriter.create()) {
        if (message.proposalId !== BigInt(0)) {
            writer.uint32(8).uint64(message.proposalId);
        }
...
exports.QueryDepositsResponse = {
    typeUrl: "/govgen.gov.v1beta1.QueryDepositsResponse",
    encode(message, writer = binary_1.BinaryWriter.create()) {
...
exports.QueryTallyResultRequest = {
    typeUrl: "/govgen.gov.v1beta1.QueryTallyResultRequest",
    encode(message, writer = binary_1.BinaryWriter.create()) {
        if (message.proposalId !== BigInt(0)) {
            writer.uint32(8).uint64(message.proposalId);
        }
...
exports.QueryTallyResultResponse = {
    typeUrl: "/govgen.gov.v1beta1.QueryTallyResultResponse",
    encode(message, writer = binary_1.BinaryWriter.create()) {
...
class QueryClientImpl {
    ...
    Proposal(request) {
        ...
        const promise = this.rpc.request("govgen.gov.v1beta1.Query", "Proposal", data);
    ...
    Proposals(request) {
        ...
        const promise = this.rpc.request("govgen.gov.v1beta1.Query", "Proposals", data);
    ...
    Vote(request) {
        ...
        const promise = this.rpc.request("govgen.gov.v1beta1.Query", "Vote", data);
    ...
    Votes(request) {
        ...
        const promise = this.rpc.request("govgen.gov.v1beta1.Query", "Votes", data);
        return promise.then((data) => exports.QueryVotesResponse.decode(new binary_1.BinaryReader(data)));
    }
    Params(request) {
        const data = exports.QueryParamsRequest.encode(request).finish();
        const promise = this.rpc.request("govgen.gov.v1beta1.Query", "Params", data);
    ...
    Deposit(request) {
        ...
        const promise = this.rpc.request("govgen.gov.v1beta1.Query", "Deposit", data);
    ...
    Deposits(request) {
        ...
        const promise = this.rpc.request("govgen.gov.v1beta1.Query", "Deposits", data);
    ...
    TallyResult(request) {
        ...
        const promise = this.rpc.request("govgen.gov.v1beta1.Query", "TallyResult", data);
